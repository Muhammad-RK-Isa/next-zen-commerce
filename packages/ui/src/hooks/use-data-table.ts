...
import { getSortingStateParser } from "@nzc/ui/lib/parsers"
import type { ExtendedColumnSort } from "@nzc/ui/types/data-table"
        ...
        if (value !== null) {
          const processedValue = Array.isArray(value)
            ...
            : typeof value === "string" && NON_ALPHANUMERIC_REGEX.test(value)
              ? value.split(SPLIT_NON_ALPHANUMERIC_REGEX).filter(Boolean)
              : [value]
