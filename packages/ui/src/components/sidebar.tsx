...
import type { ButtonProps } from "@nzc/ui/components/button";
...
import { Sheet, SheetContent } from "@nzc/ui/components/sheet";
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm text-muted-foreground outline-none ring-sidebar-ring transition-all duration-150 hover:bg-sidebar-accent/60 hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
...
const SidebarMenuSub: React.FC<React.ComponentProps<"ul">> = ({
  ...
  <ul
    ...
    className={cn(
      "ml-3.5 flex min-w-0 translate-x-px flex-col border-l border-sidebar-border py-2 pl-2.5",
      "group-data-[collapsible=icon]:hidden",
      className,
    )}
    {...props}
