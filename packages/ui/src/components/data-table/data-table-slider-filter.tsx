...
import { Slider } from "@nzc/ui/components/slider"
...
export function DataTableSliderFilter<TData>({
  ...
  const range = React.useMemo((): RangeValue => {
    return pendingRange ?? columnFilterValue ?? [min, max]
  }, [pendingRange, columnFilterValue, min, max])

  React.useEffect(() => {
    setPendingRange(columnFilterValue)
  }, [columnFilterValue])
